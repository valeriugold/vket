...
func TestEventFile(t *testing.T) {
	...
	// add user file
	tuf := EventFile{EventID: x.ID, Name: "testUFname", Size: 12345, Md5: "12345678901234567890123456789012", StoredFileID: 1}
	if err = EventFileCreate(tuf.EventID, tuf.Name, tuf.Size, tuf.Md5, tuf.StoredFileID); err != nil {
	...
	if err = UserFileCreate(tuf.EventID, tuf.Name, tuf.Size, tuf.Md5, tuf.StoredFileID); err == nil {
...
func TestUserFile(t *testing.T) {
	...
	if err = UserFileCreate(tuf.UserID, tuf.Name, tuf.Size, tuf.Md5, tuf.StoredFileID); err != nil {
